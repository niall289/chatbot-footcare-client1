  ...
  return (
    <div className="w-full max-w-lg bg-white rounded-xl shadow-lg overflow-hidden flex flex-col h-[650px] md:h-[700px]">
      ...
      <div className="bg-primary px-6 py-4 flex items-center shadow-md">
        ...
        <div className="ml-3">
          <h2 className="text-white font-semibold text-lg">FootCare Clinic</h2>
          <p className="text-primary-light text-sm">Virtual Assistant</p>
        </div>
        ...
        {showWhatsAppButton && (
          <div className="mt-4">
            <Button 
              ...
              className="w-full bg-green-500 hover:bg-green-600 text-white font-medium py-6 px-4 rounded-lg flex items-center justify-center transition-colors duration-300"
            >
